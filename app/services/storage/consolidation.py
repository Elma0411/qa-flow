...
def build_consolidated_entry(
    ...
    for qa in qa_source:
        ...
        created_item: Dict[str, Any] = {
            ...
            "source_chunk_ids": merged.get("source_chunk_ids") or [],
            "source_chunk_indexes": merged.get("source_chunk_indexes") or [],
            "source_chunk_title_paths": merged.get("source_chunk_title_paths") or [],
