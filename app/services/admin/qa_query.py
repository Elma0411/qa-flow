...
def get_qa_item(qa_id: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "source_chunk_ids": debug_payload.get("source_chunk_ids") or [],
        "source_chunk_indexes": debug_payload.get("source_chunk_indexes") or [],
        "source_chunk_title_paths": debug_payload.get("source_chunk_title_paths") or [],
